...
class DataProcesser:
    ...
    def split_sets(self, which='dataset'):
        ...
        ids_new = list(self.id_set[self.id_set[self.col_set] == 'new'][self.col_id])
        ...
        if which == 'dataset':
            ...
            self.new_set = self.dataset[self.dataset[self.col_id].isin(ids_new)]
            ...
            self.new_set = self.dataset_cropped[self.dataset_cropped[self.col_id].isin(ids_new)]
    ...
    def export_processed(self, compress=True, out_path=None, export_process_info=True):
        ...
        self.new_set.to_csv(out_path + '_new.csv', index=False)
